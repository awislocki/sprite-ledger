...
// is. Sprites with an imgBase (self-hosted; none currently) and "/" overrides
// carry no Epic tag and are skipped.
...
export function spriteImage(sprite, variantKey = "Normal") {
  ...
  // releases a pod style before fortnite-api has its image (as Cube Grim
  // was until 2026-07-30; none currently).
