...
// Four is a squad. It's also as many trades as stay legible in one
// phone-sized share image, and it keeps the derangement search trivial
// (4 players → 9 orderings).
export const MAX_ROUND_PLAYERS = 4;
